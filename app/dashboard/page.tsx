...
export default function LyvoDashboard() {
  ...
  const sidebarItems = [
    { icon: User, label: "Profile", active: false, count: null, path: "/profile" },
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                },
                {
                  ...
                  value: analyticsData.averageParticipants,
                  change: "+5%",
                  color: "primary",
                },
                {
                  icon: Brain,
                  label: "AI Summaries",
                  value: analyticsData.summariesGenerated,
                  change: "+15%",
                  color: "secondary",
                },
              ].map((stat, index) => (
                <Card
                  key={index}
                  className="group hover:shadow-xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 border-border/50 bg-card/50 backdrop-blur cursor-pointer"
                >
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div
                        className={`p-2 rounded-lg bg-${stat.color}/10 transition-all duration-300 group-hover:scale-110`}
                      >
                        <stat.icon className={`h-5 w-5 text-${stat.color}`} />
                      </div>
                      <span
                        className={`text-sm font-medium text-${stat.color} bg-${stat.color}/10 px-2 py-1 rounded-full`}
                      >
                        {stat.change}
                      </span>
                    </div>
                ...
                <Card className="border-border/50 bg-card/50 backdrop-blur">
                  ...
                  <CardContent className="space-y-4">
                    {meetings.map((meeting, index) => (
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {meeting.type === "important" && <Star className="h-4 w-4 text-secondary fill-secondary" />}
                        </div>
                      </div>
                    ))}
                    <div className="text-center pt-4">
                      <Button
                        variant="outline"
                        className="border-dashed border-primary/30 text-primary hover:bg-primary/10 bg-transparent"
                      >
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">
                            Your meetings are 23% more efficient this week!
                          </p>
                        </div>
                      </div>
                    </div>
