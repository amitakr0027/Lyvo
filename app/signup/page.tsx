...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/5 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      {/* Background decoration */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-full bg-gradient-to-b from-secondary/10 via-transparent to-transparent rounded-full blur-3xl" />
      </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="relative group">
          <div className="absolute inset-0 bg-gradient-to-r from-secondary/20 via-primary/20 to-secondary/20 rounded-2xl blur-xl opacity-60 group-hover:opacity-80 transition-opacity duration-500"></div>
          ...
          <div className="relative bg-card/80 backdrop-blur-xl border border-border/50 rounded-2xl shadow-2xl p-8 transition-all duration-500 hover:shadow-3xl hover:border-border/80">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">Join thousands of teams using Lyvo</p>
            </div>
            ...
            <form onSubmit={handleSignUp} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-secondary to-secondary/90 hover:from-secondary/90 hover:to-secondary text-secondary-foreground py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-[1.02] hover:shadow-lg group disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                {isLoading ? (
                  <div className="flex items-center justify-center">
                    <div className="animate-spin rounded-full h-5 w-5 border-2 border-secondary-foreground border-t-transparent"></div>
            ...
            <div className="mt-8 text-center">
              <p className="text-muted-foreground">
                ...
                <Link href="/signin" className="text-primary hover:text-primary/80 font-semibold transition-colors duration-300">
                  Sign In
                </Link>
              </p>
            </div>
