      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg text-muted-foreground mb-10">
            Join thousands of teams who have transformed their meetings with AI-powered collaboration. Start your free
            trial today and experience the future of video conferencing.
          </p>
